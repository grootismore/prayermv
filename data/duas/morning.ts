...
export const MORNING_DUAS: Dua[] = [
  ...
  },
  {
    ...
    translation: {
      ...
      dv: 'އޭ ﷲ! އަޅަމެން ހެނދުނުކުރީ އިބަރަސްކަލާނގެ އިރާދަފުޅާއެކުގައެވެ. އަދި އަޅަމެން ހަވީރުކުރަނީވެސް އިބަރަސްކަލާނގެ އިރާދަފުޅާއެކުގައެވެ. އަދި އަޅަމެން ދިރިތިބެނީ އިބަރަސްކަލާނގެ އިރާދަފުޅާއެކުގައެވެ. އަދި އަޅަމެން މަރުވަނީވެސް އިބަރަސްކަލާނގެ އިރާދަފުޅާއެކުގައެވެ. އަދި (މަރުވުމަށްފަހު) އަލުން ދިރުއްވައި މަޙްޝަރުކުރެއްވުން ވަނީ އިބަރަސްކަލާނގެ ޙަޟްރަތަށެވެ.',
    },
  ...
  },
  {
    ...
    translation: {
      ...
      dv: 'ކަލޭގެފާނު ވިދާޅުވާށެވެ! އެއީ އެއްކައުވަންތަ اللَّه އެވެ. اللَّه އީ، އެންމެހާ ތަކެތި އެކަލާނގެއަށް ބޭނުންތެރިވެގެންވާ، އަދި އެއްވެސް އެއްޗަކަށް، އެކަލާނގެ ބޭނުންވެވޮޑިގެންނުވާ ރަސްކަލާނގެއެވެ. އެކަލާނގެއަކަށް އެއްވެސް އެއްޗެއް އުފަންވެގެނެއް ނުވެތެވެ. އަދި އެއްވެސް އެއްޗަކަށް އެކަލާނގެ އުފަންވެވޮޑިގެނެއް ނުމެވޭމެއެވެ. އަދި އެކަލާގެއާ އެއްފަދަވެގެންވާ، ހަމައެކަކުވެސް ނުވެތެވެ. (سورة الإخلاص)\n\nކަލޭގެފާނު ވިދާޅުވާށެވެ! ފަތިހުގެ ވެރިރަސްކަލާނގެ حضرة ން ރައްކާތެރިކަން ލިބިގަންނަމެވެ. އެކަލާނގެ ހައްދަވާފައިވާހާ ތަކެތީގެ ނުބައިކަމުންނެވެ. އަދި ރޭގަނޑުގެ އަނދިރިކަން ގަދަވެގެންފިހިނދު، އެ ރޭގަނޑުގެ ނުބައިކަމުންވެސްމެއެވެ. އަދި ގޮށްތަކަށްފުމޭ މީހުން (އެބަހީ: سحر ހަދާމީހުން) ގެ ނުބައިކަމުންވެސްމެއެވެ. އަދި حسد ވެރިޔަކު حسد ވެރިވެއްޖެހިނދު، އޭނާގެ ނުބައިކަމުންވެސްމެއެވެ. (سورة الفلق)\n\nކަލޭގެފާނު ވިދާޅުވާށެވެ! މީސްތަކުންގެ ވެރިރަސްކަލާނގެ حضرة ން ރައްކާތެރިކަން ލިބިގަންނަމެވެ. (އެކަލާނގެއީ) މީސްތަކުންގެ ރަސްވަންތަ ރަސްކަލާނގެއެވެ. (އެކަލާނގެއީ) މީސްތަކުންގެ إله ވަންތަ ރަސްކަލާނގެއެވެ. ފިލައިހުރެ ވަސްވާސްދޭ شيطان އާގެ ނުބައިކަމުންނެވެ. (އެބަހީ: شيطان އާގެ ނުބައިކަމުން އެކަލާނގެ حضرة ން ރައްކާތެރިކަން ލިބިގަންނަަމެވެ.) އެ (شيطان އާ) އެއީ މީސްތަކުންގެ ހިތްތަކުގައި ވަސްވާސް އުފައްދާ شيطان އާއެވެ. ޖިންނީންގެ ތެރެއިންނާއި، މީސްތަކުންގެ ތެރެއިންވާ شيطان ންނެވެ. (سورة الناس)',
    },

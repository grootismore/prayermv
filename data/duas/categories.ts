 ...
 * adhaan-and-iqamah, ablution-and-bath, mosque) had every entry's Dhivehi
 * content swapped with an unrelated dua by the upstream dataset and were
 * emptied out, then later restored with fresh content sourced from two
 * other open repositories instead. See CONTENT_REVIEW.md for the full
 * account of both the original corruption and the backfill.
 */

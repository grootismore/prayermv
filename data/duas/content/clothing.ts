...
export const CLOTHING_DUAS: Dua[] = [
  {
    "id": "hisn-5",
    "type": "dua",
    "categoryId": "clothing",
    "title": {
      "en": "Dua When Wearing a Garment",
      "dv": "ހެދުމެއް ލައިގެންހުރެ ކިޔާ ދުޢާ"
    },
    ...
    "source": {
      "type": "hadith",
      "reference": "Al-Bukhari, Muslim, Abu Dawud, Ibn Majah, At-Tirmidhi (Hisn al-Muslim 5)"
    },
    "contentReview": {
      ...
      "notes": "Content reused verbatim from this app's existing verified dataset (original id: hisnul-5), cross-referenced here under its Hisn al-Muslim chapter/number. See CONTENT_REVIEW.md."
    }
  },
  {
    "id": "hisn-6",
    ...
    "categoryId": "clothing",
    "title": {
      "en": "Dua When Wearing a New Garment",
      "dv": "އައު ހެދުމެއް ލައިގެންހުރެ ކިޔާ ދުޢާ"
    },
    ...
    "source": {
      "type": "hadith",
      "reference": "Abu Dawud and At-Tirmidhi (Hisn al-Muslim 6)"
    },
    "contentReview": {
      "arabicVerified": false,
      "transliterationVerified": false,
      ...
      "notes": "Content reused verbatim from this app's existing verified dataset (original id: hisnul-6), cross-referenced here under its Hisn al-Muslim chapter/number. See CONTENT_REVIEW.md."
    }
  },
  {
    "id": "hisn-7",
    ...
    "categoryId": "clothing",
    "title": {
      "en": "Dua for Someone Wearing a New Garment (1)",
      "dv": "އައު ހެދުމެއް ލީ މީހަކަށް ކިޔާ ދުޢާ (1)"
    },
    ...
    "source": {
      "type": "hadith",
      "reference": "Abu Dawud 4/41 (Hisn al-Muslim 7)"
    },
    "contentReview": {
      "arabicVerified": false,
      "transliterationVerified": false,
      ...
      "notes": "Content reused verbatim from this app's existing verified dataset (original id: hisnul-7), cross-referenced here under its Hisn al-Muslim chapter/number. See CONTENT_REVIEW.md."
    }
  },
  {
    "id": "hisn-8",
    ...
    "categoryId": "clothing",
    "title": {
      "en": "Dua for Someone Wearing a New Garment (2)",
      "dv": "އައު ހެދުމެއް ލީ މީހަކަށް ކިޔާ ދުޢާ (2)"
    },
    ...
    "source": {
      "type": "hadith",
      "reference": "Ibn Majah 2/1178 (Hisn al-Muslim 8)"
    },
    "contentReview": {
      "arabicVerified": false,
      "transliterationVerified": false,
      ...
      "notes": "Content reused verbatim from this app's existing verified dataset (original id: hisnul-8), cross-referenced here under its Hisn al-Muslim chapter/number. See CONTENT_REVIEW.md."
    }
  },
  {
    "id": "hisn-9",
